export default function SectionWrapper({ children, id, style, useSvh = false, heroSection = false }) {
   ...
   return (
      <section id={id} className={`${height} w-full  dark:bg-[#111] light:bg-white flex justify-center items-center transition-colors duration-300 py-15 overflow-hidden ${style}`}>
