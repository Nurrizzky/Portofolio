      ...
      <SectionWrapper id={"experience"}>
         <div className="flex flex-col h-full w-full items-start">
            ...
            <div className="w-full h-full flex flex-col justify-between relative">
               <div onClick={hasBeenClick} className="w-full h-fit px-5 flex flex-col border-t border-b p-5 overflow-hidden cursor-pointer transition-all duration-300 ease-in-out">
                     <div className="flex justify-between w-full">   
                        ...
                        <div className="flex flex-col text-right">
                           <h2 className="text-lg">Jakarta Timur</h2>
                           <p className="text-base text-white/70">Frontend Developer</p>  
                        </div>
                     </div>
                     <AnimatePresence>
                        {isClick && (
                           ...
                           >
                              <p className="text-base text-white mt-5">Januari 2024 - Juni 2024</p>  
                              <ul className='list-disc list-inside mt-2'>
